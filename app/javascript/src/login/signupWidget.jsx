    ...
    return (
      <React.Fragment>
        <form onSubmit={this.signup}>
          ...
          <input name="password" type="password" className="form-control form-control-lg mb-3" placeholder="Password minimum 8 Characters!" value={password} onChange={this.handleChange} required />
